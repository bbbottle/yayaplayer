...
const Events = require('matter-js/src/core/Events');
const Grid = require('matter-js/src/collision/Grid');
const Vector = require('matter-js/src/geometry/Vector');
const Mouse = require('matter-js/src/core/Mouse');
...
(function() {
  ...
  Render.create = function(options) {
    ...
    render.roughCanvas = _createRoughCanvas(
  ...
  Render.world = function(render) {
    var engine = render.engine,
      world = engine.world,
      canvas = render.canvas,
      roughCanvas = render.roughCanvas,
  ...
  var _createRoughCanvas = (...args) => {
    return rough.canvas(_createCanvas(...args));
  }
